...
export function getLanguageHref(pathname: string) {
  if (pathname.startsWith('/en/metadata')) return '/metadata';
  if (pathname.startsWith('/en/compress')) return '/compress';
  if (pathname.startsWith('/en')) return '/';
  if (pathname.startsWith('/metadata')) return '/en/metadata';
...
export const appCopy = {
  zh: {
    ...
    upload: {
      ...
      choose: '选择文件',
      chooseFolder: '添加文件夹',
      chooseParentFolder: '添加母文件夹',
      noImagesInFolder: '所选文件夹中没有可上传的图片',
      uploaded: '已上传图片',
      deleteSelected: '删除选中',
    ...
    watermarkControls: {
      ...
      folderSelected: '已选择保存文件夹',
      chooseSaveFolder: '选择保存文件夹',
      clearSaveFolder: '清除保存文件夹',
      filenameRule: '导出文件名规则',
      folderNameRule: '文件夹命名规则',
      preview: '预览',
      variables: '可用变量',
      originalName: '原名',
      index: '序号',
      paddedIndex: '补零序号',
      date: '日期',
      folderSaveUnsupported: '当前浏览器不支持选择保存文件夹，将使用 ZIP 下载',
      saveSuccess: '保存成功，已清除上传图片列表',
      saveFailed: '保存失败，请重试',
      saveRetry: '重试',
      batchMode: '批量处理模式',
    ...
    metadata: {
      page: {
        srTitle: '免费图片 EXIF 与元数据查看编辑工具',
        mobileTitle: '图片元数据工具',
        mobileDescription: '查看、编辑和清除 JPG、PNG、WebP 元数据',
        desktopTitle: '图片 EXIF / 元数据查看与编辑',
        desktopDescription: '在浏览器本地查看、修改和清除图片元数据，文件不上传服务器',
        uploadTab: '上传',
        viewTab: '查看',
        editTab: '编辑',
      },
      upload: {
        ...
        addMoreHint: '拖拽或点击添加更多图片',
        emptyHint: '拖拽图片到此处或点击上传',
        support: '支持 JPG、JPEG、PNG、WebP',
        addMore: '添加更多',
        choose: '选择文件',
        files: '图片文件',
        selected: (count: number) => `已选 ${count}`,
        selectFile: '选择文件用于批量处理',
        modified: '已修改',
        reading: '读取中',
        writing: '写入中',
        failed: '失败',
        ready: (count: number) => `${count} 个标签`,
      },
      viewer: {
        emptyTitle: '尚未选择图片',
        emptyDescription: '上传 JPG、PNG 或 WebP 后可查看 ExifTool 识别到的全部元数据。',
        title: '元数据表格',
        tagCount: (count: number) => `${count} 个标签`,
        search: '搜索标签或值',
        allGroups: '全部分组',
        noResults: '没有匹配的元数据标签',
        select: '选择',
        group: '分组',
        tag: '标签',
        value: '值',
        selectTag: (name: string) => `选择 ${name}`,
        editable: '可编辑',
        readonly: '只读',
        changed: '已改',
      },
      editor: {
        emptyTitle: '选择一张图片后编辑元数据',
        common: '常用字段',
        actions: '操作',
        applying: '写入中',
        apply: '应用修改',
        download: '下载当前文件',
        clearGps: '清除 GPS',
        clearSelected: (count: number) => `清除选中 ${count}`,
        clearAll: '清除全部元数据',
        batch: '批量处理',
        selectedFiles: (count: number) => `已选 ${count} 个文件`,
        batchGps: '批量清 GPS',
        batchAll: '批量清全部',
      },
      fields: {
      ...
      messages: {
        noticeTitle: '完成',
        errorTitle: '错误',
        unsupported: (count: number, formats: string) => `${count} 个文件格式不支持。支持格式：${formats}`,
        readFailed: '元数据读取失败',
        writeFailed: '元数据写入失败',
        noChanges: '没有需要写入的修改',
        partialWrite: '部分标签写入失败，失败项已标红',
        writeSuccess: '元数据已写入新文件',
        clearAllSuccess: '已生成清除全部元数据的新文件',
        clearGpsSuccess: '已生成清除 GPS 的新文件',
        clearSelectedSuccess: '已清除选中的元数据字段',
        batchSuccess: (count: number) => `已打包下载 ${count} 个处理后的文件`,
        batchFailed: (count: number) => `${count} 个文件处理失败`,
      },
      geo: {
        heading: '浏览器端图片 EXIF 与元数据工具',
        paragraphs: [
          '图片元数据工具可在浏览器本地查看和编辑 JPG、PNG、WebP 图片中的 EXIF、IPTC、XMP、ICC、PNG、WebP 和 Composite 信息。文件只在本机浏览器中读取和写回，不会上传到服务器。',
          '该工具适合摄影师、内容创作者、电商团队和隐私敏感的图片处理流程，用于检查拍摄参数、修改版权信息、清除 GPS 定位或批量移除发布前不需要的元数据。',
        ],
        features: [
          {
            title: '查看所有标签',
            description: '按 File、EXIF、XMP、IPTC、ICC、PNG、WebP、Composite 等分组展示 ExifTool 能识别的信息。',
          },
          {
            title: '编辑常用字段',
            description: '支持标题、描述、关键词、作者、版权、拍摄时间、相机、镜头、软件、评论和 GPS 字段。',
          },
          {
            title: '隐私清理',
            description: '可清除全部元数据、仅清除 GPS，或选择具体字段清除，并支持多文件 ZIP 下载。',
          },
        ],
        faqHeading: '常见问题',
        faqs: [
          {
            question: '图片元数据会上传到服务器吗？',
            answer: '不会。读取、编辑和清除元数据都在浏览器本地完成，原图和处理后的文件不会上传到远程服务器。',
          },
          {
            question: '支持哪些图片格式？',
            answer: '当前版本支持 JPG、JPEG、PNG 和 WebP。其它格式会显示不支持提示，不纳入写回流程。',
          },
          {
            question: '可以修改所有元数据吗？',
            answer: '工具会展示 ExifTool 能识别的全部标签，并允许尝试修改非系统、非计算型字段。文件系统信息、Composite 计算字段、MakerNotes 等高风险或不可写字段会保持只读或显示写入失败。',
          },
          {
            question: '清除元数据会降低图片画质吗？',
            answer: '元数据写回由 ExifTool 处理，目标是不重新编码像素数据，尽量避免画质损失。不同格式和标签结构的可写能力以 ExifTool 实际结果为准。',
          },
          {
            question: '可以批量清除 GPS 吗？',
            answer: '可以。选择多个文件后可批量清除 GPS 或全部元数据，并自动打包为 ZIP 下载。',
          },
        ],
      },
    },
  ...
  en: {
    ...
    upload: {
      ...
      addMore: 'Add more',
      choose: 'Choose files',
      chooseFolder: 'Add folder',
      chooseParentFolder: 'Add parent folder',
      noImagesInFolder: 'No supported images were found in the selected folder.',
    ...
    watermarkControls: {
      ...
      clearSaveFolder: 'Clear save folder',
      filenameRule: 'Export filename rule',
      folderNameRule: 'Folder naming rule',
      preview: 'Preview',
      variables: 'Variables',
      ...
      date: 'date',
      folderSaveUnsupported: 'This browser does not support choosing a save folder. ZIP download will be used.',
      saveSuccess: 'Saved successfully. Uploaded images were cleared.',
    ...
    metadata: {
      page: {
        srTitle: 'Free image EXIF and metadata viewer and editor',
        mobileTitle: 'Image Metadata Tool',
        mobileDescription: 'View, edit, and remove JPG, PNG, and WebP metadata',
        desktopTitle: 'Image EXIF / Metadata Viewer and Editor',
        desktopDescription: 'View, edit, and remove image metadata locally in your browser',
        uploadTab: 'Upload',
        viewTab: 'View',
        editTab: 'Edit',
      },
      upload: {
        title: 'File upload',
        release: 'Release files to read',
        addMoreHint: 'Drag or click to add more images',
        emptyHint: 'Drag images here or click to upload',
        support: 'Supports JPG, JPEG, PNG, and WebP',
        addMore: 'Add more',
        choose: 'Choose files',
        files: 'Image files',
        selected: (count: number) => `${count} selected`,
        selectFile: 'Select file for batch processing',
        modified: 'Modified',
        reading: 'Reading',
        writing: 'Writing',
        failed: 'Failed',
        ready: (count: number) => `${count} tags`,
      },
      viewer: {
        emptyTitle: 'No image selected',
        emptyDescription: 'Upload a JPG, PNG, or WebP image to inspect every metadata tag ExifTool can recognize.',
        title: 'Metadata table',
        tagCount: (count: number) => `${count} tags`,
        search: 'Search tags or values',
        allGroups: 'All groups',
        noResults: 'No matching metadata tags',
        select: 'Select',
        group: 'Group',
        tag: 'Tag',
        value: 'Value',
        selectTag: (name: string) => `Select ${name}`,
        editable: 'Editable',
        readonly: 'Read only',
        changed: 'Changed',
      },
      editor: {
        emptyTitle: 'Select an image to edit metadata',
        ...
        selectedFiles: (count: number) => `${count} files selected`,
        batchGps: 'Batch clear GPS',
        batchAll: 'Batch clear all',
      },
      fields: {
        title: 'Title',
      ...
      messages: {
        noticeTitle: 'Done',
        errorTitle: 'Error',
        unsupported: (count: number, formats: string) => `${count} unsupported file(s). Supported formats: ${formats}`,
        readFailed: 'Metadata read failed',
        writeFailed: 'Metadata write failed',
        noChanges: 'There are no changes to write',
        partialWrite: 'Some tags failed to write and are marked in red',
        writeSuccess: 'Metadata was written to a new file',
        clearAllSuccess: 'A new file with metadata removed is ready',
        clearGpsSuccess: 'A new file with GPS removed is ready',
        clearSelectedSuccess: 'Selected metadata fields were removed',
        batchSuccess: (count: number) => `${count} processed file(s) were downloaded as a ZIP`,
        batchFailed: (count: number) => `${count} file(s) failed to process`,
      },
      geo: {
        heading: 'Browser-based image EXIF and metadata tool',
        paragraphs: [
          'The image metadata tool reads and edits EXIF, IPTC, XMP, ICC, PNG, WebP, and Composite metadata from JPG, PNG, and WebP images locally in your browser. Files are not uploaded to a server.',
          'It is useful for photographers, creators, ecommerce teams, and privacy-sensitive image workflows that need to inspect capture settings, update copyright fields, remove GPS location, or strip metadata before publishing.',
        ],
        features: [
          {
            title: 'Inspect every tag',
            description: 'Metadata is grouped by File, EXIF, XMP, IPTC, ICC, PNG, WebP, Composite, and related ExifTool sections.',
          },
          {
            title: 'Edit common fields',
            description: 'Update title, description, keywords, author, copyright, capture time, camera, lens, software, comments, and GPS values.',
          },
          {
            title: 'Privacy cleanup',
            description: 'Remove all metadata, remove only GPS data, or clear selected fields, with batch ZIP download for multiple files.',
          },
        ],
        faqHeading: 'Frequently asked questions',
        faqs: [
          {
            question: 'Are image files uploaded to a server?',
            answer: 'No. Metadata reading, editing, and removal run locally in your browser. Original and processed files are not uploaded to a remote server.',
          },
          {
            question: 'Which image formats are supported?',
            answer: 'This version supports JPG, JPEG, PNG, and WebP. Other formats show an unsupported format message and are not included in the write workflow.',
          },
          {
            question: 'Can every metadata field be edited?',
            answer: 'The tool displays every tag ExifTool can recognize and allows editable attempts for non-system, non-computed fields. File system fields, Composite calculated tags, MakerNotes, and unsupported format-specific fields remain read only or show a write failure.',
          },
          {
            question: 'Does removing metadata reduce image quality?',
            answer: 'ExifTool metadata writing is used to avoid re-encoding pixel data where possible. Actual write support depends on the image format and tag structure.',
          },
          {
            question: 'Can GPS data be removed in bulk?',
            answer: 'Yes. Select multiple files, batch clear GPS data or all metadata, and download the processed files as a ZIP archive.',
          },
        ],
      },
    },
